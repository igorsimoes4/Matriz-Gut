...
- Exportar a lista para PDF/Excel.
- Gráfico de barras por classificação (usando JavaFX Charts).
- Filtro por classificação ou busca por texto.
- Múltiplos usuários / login.
- Trocar SQLite por MySQL/PostgreSQL (basta mudar a string de conexão e
  o driver em `DatabaseManager`).
